const { getAllOrders, getOrderById, editOrder, createOrder } = require("../controllers/orderController");
...
const createOrderHandler = async (req, res) => {
  ...
  try {
    const response = await createOrder(description, total_price);
...
module.exports = {editOrderHandler, createOrderHandler, getAllOrdersHandler, getOrderByIdHandler};
